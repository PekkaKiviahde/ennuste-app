...
- Päivitettiin nimeäminen: workflow-viittaukset `0)–5)` = `E0..E5` (ei “0→6”).
...
- Tarkista workflow: `spec/workflows/01_mvp_flow.md` (vaiheet `0)–5)` = `E0..E5`) ja `spec/workflows/00_workflow_outline.md`.
