...
const DEMO_QUICK_LOGINS: DemoQuickLogin[] = [
  ...
  { group: "Demo A", label: "Organisaatio-admin (A)", username: "org.admin.a" },
  ...
  { group: "Demo B", label: "Organisaatio-admin (B)", username: "org.admin.b" },
  ...
  { group: "Kide", label: "Organisaatio-admin (Kide)", username: "kide.orgadmin" }
];
